...
//             order.Book_ID === data.orderId ? { ...order, Book_Status: 'Cancelled' } : order
//           )
//         );
//       }
//     });
...
//         spEmail: currentUser?.U_Email,
//       });
      
//       if (response.status === 200) {
//         // Emit socket event on successful acceptance
...
//         // Update only the status for the canceled service provider
//         setOrders((prevOrders) => prevOrders.map(order =>
//           order.Book_ID === orderId && order.serviceProviderId === currentUser?.U_Email
//             ? { ...order, Book_Status: 'Cancelled' }
//             : order
//         ));
//       } else {
...
//                     </div>
//                   )}
//                   {order.Book_Status === "Cancelled" && order.serviceProviderId === currentUser?.U_Email && (
//                     <p className="text-red-500 mt-2">You have canceled this order.</p>
//                   )}
//                 </li>
//               ))}
//             </ul>
